    ...
    <section id="welcome" class="template-section">
        <div style="display: inline-block" class="welcome_box">
            ...
            <div id=\"login-play\" onclick='openGame()'>
                <a id=\"play-button\" href='game/game.php'>Play Game</a>
            </div>
    ...
    <section id="introduction">
        <div class="section-content">
            <div class="intro-area">
                <img src="game/assets/pinkship.png">
            ...
            <div class="intro-area-side" id="intro-area-side-yellow">
                <img src="game/assets/yellowship.png">
...
<audio id="login_music" src="game/assets/audio/space_sprinkles.mp3" loop></audio>
